...
export default function ToS() {
  return (
    <>
      <SeoHead title='House of Charts - Terms of Service' />
      <Layout>
  ...
  <div data-custom-class="body">
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          <bdt className="question">
            <a
              href="https://houseofcharts.com"
              target="_blank"
              data-custom-class="link"
            >
              https://houseofcharts.com
            </a>
          </bdt>{" "}
      ...
      >
        <bdt className="question">
          We provide a prototype for a platform where you can generate discharge
          report from EHR notes.
        </bdt>
      </div>
      <div
        className="MsoNormal"
      ...
      >
        ...
        >
          ...
          <bdt className="block-component">
            email at <bdt className="question">contact@houseofcharts.com</bdt>
            ...
            <bdt className="block-component">
              <bdt className="block-component">,&nbsp;</bdt>
              <bdt className="question">Switzerland</bdt>
              <bdt className="statement-end-if-in-editor" />
            </bdt>
            .
          </bdt>
      ...
      >
        ...
        >
          ...
          <bdt className="statement-end-if-in-editor" />
          ), and <bdt className="question">House Of Charts</bdt>, concerning
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          <bdt className="question">contact@houseofcharts.com</bdt>. If we ever
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        <span style={{ fontSize: 15 }}>
          ...
          <bdt className="question">contact@houseofcharts.com</bdt>
          <bdt className="block-component" />.
          <bdt className="statement-end-if-in-editor" />
        </span>
      </div>
          ...
          <div className="MsoNormal" style={{ lineHeight: "1.1" }}>
            ...
            <ul>
              ...
              >
                ...
                >
                  <bdt className="question">
                    Extracting intellectual property
                  </bdt>
                  <bdt className="forloop-component" />
                </span>
              </li>
          ...
          <span style={{ color: "rgb(89, 89, 89)" }}>
            <span style={{ fontSize: 14 }}>
              <span data-custom-class="body_text">
                ...
                <bdt className="block-component" />
                authorize
                <bdt className="statement-end-if-in-editor" /> us, the Services,
    ...
    >
      ...
      >
        ...
        <strong>
          ...
          >
            <a
              href="https://svenadrian.com/privacy_policy"
              target="_blank"
              data-custom-class="link"
            >
              https://svenadrian.com/privacy_policy
            </a>
          </bdt>
        </strong>
    ...
    >
      ...
      >
        ...
        your country to residence.{" "}
        <bdt className="question">House Of Charts</bdt> and yourself both agree
        to submit to the non-exclusive jurisdiction of the courts of{" "}
        <bdt className="question">Zurich</bdt>, which means that you may make a
        claim to defend your consumer protection rights in regards to these
        Legal Terms in <bdt className="block-component" />
        <bdt className="question">Switzerland</bdt>
        <span
          style={{
            fontSize: "11pt",
    ...
    >
      ...
      <bdt className="block-component" />
      <bdt className="question">Zurich</bdt>,{" "}
      <bdt className="block-component" />
      <bdt className="question">Switzerland</bdt>
      <bdt className="else-block" />. The language of the proceedings shall be{" "}
      <bdt className="question">German</bdt>. Applicable rules of substantive
