      ...
      <div className="container-xl">
        <div className="relative">
          <div className="bg-theme banner-bg col-12 absolute top-0 left-0">
            ...
            />
            <Circle
              className="circle left-[2.5%] top-[29%] hidden md:block"
              width={85}
              height={85}
            />
            <Circle
            ...
            />
            <Circle
              className="circle right-[2%] top-[30%] hidden md:block"
              width={73}
              height={73}
              fill={false}
            />
            ...
            />
            <Circle
              className="circle right-[33%] top-[54%] hidden sm:block"
              width={20}
              height={20}
            />
            <Circle
          ...
          <div className="row border-y border-border 2xl:py-5">
